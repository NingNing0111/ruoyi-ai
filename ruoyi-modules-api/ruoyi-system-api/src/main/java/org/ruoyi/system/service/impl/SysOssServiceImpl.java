...
public class SysOssServiceImpl implements ISysOssService, OssService {
	...
	private LambdaQueryWrapper<SysOss> buildQueryWrapper(SysOssBo bo) {
		...
		lqw.between(params.get("beginCreateTime") != null && params.get("endCreateTime") != null, SysOss::getCreateTime,
	...
	public MultipartFile downloadByFile(Long ossId) throws IOException {
		...
		try (InputStream inputStream = storage.getObjectContent(sysOss.getUrl())) {
			...
			return new MockMultipartFile(sysOss.getFileName(), sysOss.getOriginalName(),
