...
public class SysMenuServiceImpl implements ISysMenuService {
	...
	public List<Long> selectMenuListByPackageId(Long packageId) {
		...
		if (tenantPackage.getMenuCheckStrictly()) {
			parentIds = baseMapper.selectObjs(
					new LambdaQueryWrapper<SysMenu>().select(SysMenu::getParentId).in(SysMenu::getMenuId, menuIds),
					x -> {
						return Convert.toLong(x);
					});
		}
		return baseMapper.selectObjs(new LambdaQueryWrapper<SysMenu>().in(SysMenu::getMenuId, menuIds)
	...
	public List<Tree<Long>> buildMenuTreeSelect(List<SysMenuVo> menus) {
		...
		return TreeBuildUtils.build(menus,
				(menu, tree) -> tree.setId(menu.getMenuId())
	...
	public boolean checkMenuNameUnique(SysMenuBo menu) {
		boolean exist = baseMapper.exists(new LambdaQueryWrapper<SysMenu>().eq(SysMenu::getMenuName, menu.getMenuName())
