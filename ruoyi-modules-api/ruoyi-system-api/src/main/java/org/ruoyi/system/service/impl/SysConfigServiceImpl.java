...
public class SysConfigServiceImpl implements ISysConfigService {
	...
	public String selectConfigByKey(String configKey) {
		SysConfig retConfig = baseMapper
			.selectOne(new LambdaQueryWrapper<SysConfig>().eq(SysConfig::getConfigKey, configKey));
	...
	public boolean selectRegisterEnabled(String tenantId) {
		SysConfig retConfig = baseMapper
			.selectOne(new LambdaQueryWrapper<SysConfig>().eq(SysConfig::getConfigKey, "sys.account.registerUser")
	...
	private LambdaQueryWrapper<SysConfig> buildQueryWrapper(SysConfigBo bo) {
		...
		lqw.between(params.get("beginTime") != null && params.get("endTime") != null, SysConfig::getCreateTime,
	...
	public boolean checkConfigKeyUnique(SysConfigBo config) {
		...
		SysConfig info = baseMapper
			.selectOne(new LambdaQueryWrapper<SysConfig>().eq(SysConfig::getConfigKey, config.getConfigKey()));
