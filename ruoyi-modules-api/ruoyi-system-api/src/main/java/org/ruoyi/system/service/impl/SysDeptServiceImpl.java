...
public class SysDeptServiceImpl implements ISysDeptService, DeptService {
	...
	public List<Tree<Long>> buildDeptTreeSelect(List<SysDept> depts) {
		...
		return TreeBuildUtils.build(depts,
				(dept, tree) -> tree.setId(dept.getDeptId())
	...
	public SysDeptVo selectDeptById(Long deptId) {
		...
		SysDeptVo parentDept = baseMapper.selectVoOne(new LambdaQueryWrapper<SysDept>().select(SysDept::getDeptName)
	...
	public long selectNormalChildrenDeptById(Long deptId) {
		return baseMapper
			.selectCount(new LambdaQueryWrapper<SysDept>().eq(SysDept::getStatus, UserConstants.DEPT_NORMAL)
	...
	public boolean checkDeptNameUnique(SysDeptBo dept) {
		boolean exist = baseMapper.exists(new LambdaQueryWrapper<SysDept>().eq(SysDept::getDeptName, dept.getDeptName())
	...
	private void updateParentDeptStatusNormal(SysDept dept) {
		...
		baseMapper.update(null, new LambdaUpdateWrapper<SysDept>().set(SysDept::getStatus, UserConstants.DEPT_NORMAL)
	...
	private void updateDeptChildren(Long deptId, String newAncestors, String oldAncestors) {
		List<SysDept> children = baseMapper
			.selectList(new LambdaQueryWrapper<SysDept>().apply(DataBaseHelper.findInSet(deptId, "ancestors")));
